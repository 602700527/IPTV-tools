...
export const styles = `
  ...
  .profile-hero-content { padding: 24px; }
  ...
  .avatar-ring.vip-ring { opacity: 0.3; }
  ...
  .scheme-section-title svg { width: 16px; height: 16px; color: var(--accent); }
  ...
  .btn-renew:hover { opacity: 0.9; transform: translateY(-1px); }
