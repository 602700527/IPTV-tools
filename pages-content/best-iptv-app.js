...
.app-card h3{font-size:1.25rem;font-weight:700;margin-bottom:0.75rem;color:var(--accent)}
.app-card p{color:var(--text-secondary);font-size:0.95rem;line-height:1.6;margin-bottom:1rem}
.app-features{list-style:none;padding:0;margin-bottom:1.5rem}
.app-features li{padding:0.5rem 0;color:rgba(255,255,255,0.8);font-size:0.9rem;border-bottom:1px solid rgba(255,255,255,0.05)}
.app-features li:before{content:"✓ ";color:var(--green);margin-right:0.5rem}
.rating{color:var(--yellow);font-size:1.1rem;margin-bottom:0.5rem}
