    ...
    channelListHtml = channels.slice(0, INITIAL_BATCH).map((ch, idx) => {
      ...
      return '<div class="channel-row" data-hash="' + escapeHtml(ch.hash) + '" data-name="' + escapeHtml(ch.name) + '" data-logo="' + escapeHtml(ch.logo || '') + '" data-group="' + escapeHtml(ch.group || category) + '">' +
        ...
        '<label class="channel-checkbox">' +
          ...
          '<input type="checkbox" onchange="window.updateSelectedCount()">' +
...
<body>
    ...
    <div class="main-container">
      ...
      <div class="batch-bar">
        ...
        <div class="batch-actions">
          ...
          <button class="btn btn-primary" onclick="window.downloadSelectedM3U()" title="下载M3U">
          ...
          <button class="btn btn-shuffle" onclick="window.shuffleChannels()" title="换一批">
  ...
  <script>
    ...
    function toggleFavoriteReal(btn) {
      ...
      if (!token) {
        confirm('请先登录后再收藏频道。\n\n点击确定跳转到登录页面') && (window.location.href = '/login');
        return;
      }
    ...
    async function downloadSelectedM3UReal() {
      ...
      const btn = document.querySelector('[onclick="window.downloadSelectedM3U()"]');
