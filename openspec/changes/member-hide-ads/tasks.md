...
- [ ] 5.1 `plans-page.js` 第 577 行：免费计划功能列表中的"无广告"改为"网站广告"
- [ ] 5.2 `plans-page.js` 第 634 行：VIP 计划功能列表添加"网站免广告"
- [ ] 5.3 `components/page-footer.js` 第 29 行 FAQ：添加会员网站免广告说明

## 6. 测试验证

- [ ] 6.1 测试未登录用户：广告正常显示
- [ ] 6.2 测试登录但无订阅用户：广告正常显示
- [ ] 6.3 测试登录且有有效订阅用户：广告隐藏
- [ ] 6.4 测试管理员关闭功能后：所有用户广告正常显示
